...
import {HttpsError} from "firebase-functions/lib/common/providers/https"; // TODO: Use "firebase-functions/v1/https" in .js build
...
// Dependencies
//
const cloudStorage = new CloudStorage(admin.storage());
...
export const convertCloudStorageImages = cloudStorage.convertToJPG;

// Scheduled job for expiring subscriptions in the case of missing store events
export const expireSubscriptions = functions.pubsub.schedule("every 10 mins")
