...
class NoOpacityFlexibleSpaceBar extends StatefulWidget {
  /// Creates a flexible space bar.
  ///
  /// Most commonly used in the [AppBar.flexibleSpace] field.
  const NoOpacityFlexibleSpaceBar({
    Key? key,
    this.title,
    this.background,
    this.centerTitle,
  ...
  @override
  State<NoOpacityFlexibleSpaceBar> createState() =>
      _NoOpacityFlexibleSpaceBarState();
}

class _NoOpacityFlexibleSpaceBarState extends State<NoOpacityFlexibleSpaceBar> {
